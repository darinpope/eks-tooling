...
RUN cd /usr/local/bin && \
    ...
    curl -o aws-iam-authenticator https://amazon-eks.s3.us-west-2.amazonaws.com/1.17.6/2020-07-08/bin/linux/amd64/aws-iam-authenticator && \
    chmod +x ./aws-iam-authenticator && \
    curl --silent --location "https://github.com/weaveworks/eksctl/releases/download/0.24.0/eksctl_Linux_amd64.tar.gz" | tar xz -C /tmp && \
    mv /tmp/eksctl /usr/local/bin && \
    curl -o kubectl https://amazon-eks.s3.us-west-2.amazonaws.com/1.17.6/2020-07-08/bin/linux/amd64/kubectl && \
